...
\vspace*{10mm}
To the Penn Development Research Initiative (PDRI),

I write this research statement to express my interest in, and document my qualifications for, a post doctoral fellowship with PDRI for the 2022-2023 academic year (and beyond). I am a doctoral candidate in the Department of Political Science at the University of Illinois, and I expect to defend my dissertation by May 2022 under the supervision of Matt Winters, Xinyuan Dai, Bob Pahre, and Rob Carroll. 

My research falls under three umbrellas: (1) the political economy of foreign aid; (2) political methodology; and (3) public policy. With respect to the first, I have special interest both in identifying the foreign policy goals countries pursue through their aid allocation, and in studying how aid giving serves as an arena in which donor governments compete to maximize foreign policy goals. To address these issues, I rely on various tools, from game theory to machine learning, as well as classical econometric techniques. 

The second agenda centers on novel applications of machine learning in observational data, text-as-data techniques, and extensions of existing approaches for testing theoretical models. Some of this research intersects with the politics of foreign aid but also extends to other contexts of interest to political scientists such as religion in politics and political communication. 

The last research agenda comes out of work I have done while serving as an Associate Fellow with the Federal Office of Evaluation Sciences. In collaboration with a cross-disciplinary team of scholars, I have contributed to public policy research on issues ranging from vaccine uptake to small business survival in the wake of COVID-19. This research involves the use of randomized controlled trials, as well as quasi-experimental designs and observational studies.
...
Since OES work is intended to inform the policymaking process for federal government partners, a premium is placed on making our methods transparent and accessible to non-technical audiences. OES further values professionalism from all its employees and associates in their capacity as representatives of the federal government. It also demands discretion in dealing with confidential data and communications.


# Conclusion

The above summary demonstrates the overall trajectory of my immediate and future research, and is evidence of my productivity as a scholar. My research agenda consists of a complementary mix of theoretical, methodological, and empirical work, and I believe my research interests and methodological background make me uniquely qualified to be a post doctoral fellow with PDRI.

I have a strong substantive interest in the politics of foreign aid and international development. Further, I am well acquainted with advanced causal inference methods given my strong methodological training at Illinois and my applied experience as a methods specialist at OES. In addition to the policy research at OES I highlighted above, I have also directly supported OES's internal replication process for collaborations with USAID that have involved field experiments in aid recipient countries. 

I believe a post doctoral fellowship with PDRI would allow my research to develop in exciting new directions, and I would look forward to productive collaborations with others at PDRI. Thank you for your consideration, and if you have any questions feel free to email or call me any time.
